...
const Whoweare=()=>{
    return (
        ...
        className={`${styles.paddings} relative z-10 text-center`} id='Values' >
          <motion.div
        variants={fadeIn("right", "tween", 0.2, 1)}
      >
          ...
          <h2 className="font-bold text-8xl mb-32 w-full text-center text-white">Who we are?</h2>
           <div className="w-[100%] mx-auto relative whoweare">
             <ul className="w-full flex flex-col items-start justify-between ml-4 grid  grid-cols-1 sm:grid-cols-1  md:grid-cols-2 md:gap-10 gap-5">
              <li className="my-8 first:mt-0 last:mb-0 w-[80%] mx-auto flex flex-col items-center justify-between border-2 border-yellow-500 p-8 rounded-lg w-full h-full md:p-10 ">
...
next level in key objectives.</p>
              ...
              <li className="first:mt-0 last:mb-0 w-[80%] mx-auto flex flex-col items-center justify-between align-items items-center border-2 border-yellow-500 p-8 rounded-lg w-full h-full">
...
and digital products, thereby showing you the best results.</p>
              ...
              <li className="my-8 first:mt-0 last:mb-0 w-[80%] mx-auto flex flex-col items-center justify-between border-2 border-yellow-500 p-8 rounded-lg w-full h-full">
